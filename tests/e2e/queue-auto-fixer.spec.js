...
test.describe('Queue auto fixer', () => {
  test('auto fixer emits add-worktree-sessions for Tier 3 PR needing fixes', async ({ page }) => {
          ...
          tasks: [
            {
              ...
              record: { tier: 3, reviewOutcome: 'needs_fix', notes: 'Please fix X' },
