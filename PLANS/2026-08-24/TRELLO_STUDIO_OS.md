...
orchestrator is execution. This doc turns the external advice ("one workspace, the Trello HQ board,
...
the triage agent, the Trello HQ board, and the calendar all run on cards whether or not a repo is
