...
- P0 open longer than 24h: escalate to Decisions Required on the Trello HQ board.
...
- The Trello HQ board's Current Priorities list and the milestone cards with dates.
...
- The daily sweep also produces a backburner report on the Trello HQ board: oldest cards, count by
